...
import (
	...
	"time"
	"syscall"
	"github.com/ugifractal/go-create-react-app/api"
	"github.com/ugifractal/go-create-react-app/server"
...
func main() {
	...
	kp := kingpin.New(filepath.Base(os.Args[0]), "Demo of create-react-app integration")
	kp.Version(version)
